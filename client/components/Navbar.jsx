        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-white shadow-lg border-b border-gray-200 w-full">
            <div className="w-full px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between items-center h-16">
                    ...
                    {/* Desktop Menu - Horizontal - CHỈ HIỂN THỊ TRÊN MÀN HÌNH LỚN */}
                    {isDesktop && (
                    ...
                    <div className="flex items-center space-x-3">
                        {/* User Info - chỉ hiển thị trên desktop LỚN */}
                        {isDesktop && (
                            <div>
                        ...
                        <button
                            onClick={logout}
                            className="bg-red-600 text-white px-3 py-2 rounded-lg text-sm font-medium hover:bg-red-700 hover:shadow-md transition-all duration-200 transform hover:scale-105 active:scale-95"
                        >
                            <span className="hidden sm:inline">Đăng Xuất</span>
                        </button>

                        {/* Mobile menu button - CHỈ HIỂN THỊ TRÊN MÀN HÌNH NHỎ */}
                        {!isDesktop && (
                            <button
                                onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
                                className="inline-flex items-center justify-center p-2 rounded-lg text-gray-600 hover:text-indigo-600 hover:bg-indigo-50 transition-all duration-200"
                            >
